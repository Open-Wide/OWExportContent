...
class OWExportContentCreateClass extends OWExportContentHandler
{
    /**
    ...
    function OWExportContentCreateClass( )
    {
    }
    ...
    function execute( $xml )
    {
        ...
        foreach ( $classList as $class )
        {
            ...
            $classObjectNamePattern = htmlspecialchars_decode($class->getAttribute( 'objectNamePattern' ));
            ...
            if ( $class )
            {
                ...
                switch( $classExistAction )
                {
                    case 'replace':
                    {
                        ...
                        $class->setAttribute( 'url_alias_name', htmlspecialchars_decode($classURLAliasPattern) );
