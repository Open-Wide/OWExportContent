...
class OWExportContentHandlerManager
{
    ...
    {
        if(!OWExportContentHandlerManager::$Instance)
        {
            OWExportContentHandlerManager::$Instance = new OWExportContentHandlerManager();
        }
        return OWExportContentHandlerManager::$Instance;
    }
    /*!
     \static
    ...
    */
    function initialize()
    {
        $ini = eZINI::instance( 'owexportcontent.ini' );
        ...
        foreach( $extensionDirectoryList as $extensionDirectory )
        {
            ...
            do
            {
                $fileName = eZExtension::baseDirectory() . '/' . $extensionDirectory . '/owexportcontenthandler/' . $handler . '.php';
